...
export const api = {
  basepath: {
    ...
    // main: 'https://localhost/door-v2-pegadaian/public/',
    main: 'http://localhost:3000/',
    // uam: process.env.REACT_APP_UAM_BASEPATH || 'https://uam-dev.apps.mypaas.telkom.co.id/',
    // uam: 'https://localhost/door-v2-pegadaian/public/composite/user/authenticate',
    uam: 'https://localhost:3000/auth/login',
  },
};
